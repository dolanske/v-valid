...
describe("[Validators] Type", () => {
  test("ARRAY type", () => {
    ...
    expect(type.str.validate(new String("Hello world"))).toBeTruthy()
  ...
  test("NUMBER type", () => {
    ...
    expect(type.num.validate(new Number(10))).toBeTruthy()
  ...
  test("ARRAY type", () => {
    ...
    expect(type.arr.validate(new Array())).toBeTruthy()
  ...
  test("OBJECT type", () => {
    ...
    expect(type.obj.validate(new Object({ test: "true" }))).toBeTruthy()
